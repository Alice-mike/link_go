...
import com.soonvein.cloud.fragment.DownLessonMainFragment;
...
import com.soonvein.cloud.fragment.LessonFragment_test2;
...
//    ViewPager viewPager;
    ...
    private DownLessonMainFragment downLessonMainFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer2=MediaPlayer.create(this,R.raw.lessondown);
                ...
                runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (recLen < 0) {
                            ...
                            intent.setClass(LessonDownActivity.this, NewMainActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.lessondown_layout;
    }
...
//        startAD();
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        downLessonMainFragment=new DownLessonMainFragment();
        mFragmentList.add(downLessonMainFragment);
