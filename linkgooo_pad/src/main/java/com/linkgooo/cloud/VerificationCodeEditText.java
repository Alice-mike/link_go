...
import com.soonvein.cloud.VerificationAction;
...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void initPaint() {
        ...
        mSelectedBackgroundPaint.setColor(getColor(R.color.background));
        ...
        mBottomSelectedPaint.setStrokeWidth(2);
...
//                getColor(android.R.color.darker_gray));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mFigures; i++) {
            ...
            int end = width + start;
            //画一个矩形
            canvas.drawRect(start, 0, end, height-7, mSelectedBackgroundPaint);
            canvas.restore();
        }
        //绘制底线
        for (int i = 0; i < mFigures; i++) {
