...
public class IsopenCabinet extends BasePresenter<IsopenCabinet.isopen> {
    ...
    public void isopen(int openType, String deviceId,String uid,String fromType){
        this.mCompositeSubscription.add(this.mDataManager.isOpenCabinet(openType,deviceId,uid,fromType)
