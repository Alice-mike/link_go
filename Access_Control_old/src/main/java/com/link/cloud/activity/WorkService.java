 ...
 */
public class WorkService extends AliyunMessageIntentService implements SyncUserFeature.syncUser,DeviceHeartBeatContract.Devicehearbeat{
    @Bind(R.id.edit_code)
    EditText edit_code;
    boolean ret=false;
...
//            Toast.makeText(WorkService.this, "检查网络连接是否打开", Toast.LENGTH_SHORT).show();
            ...
            if (isNetWork!=true){
//                String deviceId= FileUtils.loadDataFromFile(activity,"deviceId.text");
